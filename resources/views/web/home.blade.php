    ...
    <section id="works">
        <div class="container">
            <div class="header-cyber">
                ...
                <div class="slider-controls-cyber project-slider-controls" style="display: none;">
                    <button class="slider-arrow-btn prev-projects" aria-label="Previous project card"><i data-lucide="chevron-left"></i></button>
                    <button class="slider-arrow-btn next-projects" aria-label="Next project card"><i data-lucide="chevron-right"></i></button>
                </div>
            </div>
